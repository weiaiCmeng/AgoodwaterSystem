...
/**
 * Created by shiqiang on 2016/10/9.
 */
public class UpdateManager {
    ...
    private static final String saveFileName = savePath + "waterSystem.apk"; //完整路径名
    ...
    public void showDownloadDialog() {
        ...
        System.out.println("我是apk:" + apkUrl);
    }

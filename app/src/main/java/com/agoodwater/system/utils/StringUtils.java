...
public abstract class StringUtils {
	 ...
	 * E.g. "az\n" will delete 'a's, 'z's and new_sign lines.
	 * @return the resulting String
	 */
	...
	/**
	 * Append the given String to the given String array, returning a new_sign array
	 * consisting of the input array contents plus the given String.
	 * @param array the array to append to (can be {@code null})
	 * @param str the String to append
	 * @return the new_sign array (never {@code null})
	 */
	 ...
	 * <p>The order_selector of elements in the original arrays is preserved.
	 * @param array1 the first array (can be {@code null})
	 * @param array2 the second array (can be {@code null})
	 * @return the new_sign array ({@code null} if both given arrays were {@code null})
	 */
	 ...
	 * @return an array without duplicates, in natural sort order_selector
	 */
	 ...
	 * line breaks: e.g. "\r\n\f" will delete all new_sign lines and line feeds in a String.
	 * @return an array of the tokens in the list
	 * @see #tokenizeToStringArray
	 */

...
public class QueryDetailsAdapter extends RecyclerView.Adapter<QueryDetailsAdapter.ViewHolder> {

    private Context mContext;
    private LayoutInflater inflater;
    private List<QueryDetailsBean.DataBean.OrderListBean> mList = new ArrayList<>();
    private QueryDetailsBean.DataBean.OrderListBean item;
    private StringBuffer sb;

    public QueryDetailsAdapter(Context context, List<QueryDetailsBean.DataBean.OrderListBean> list) {
    ...
    public void setAdapter(List<QueryDetailsBean.DataBean.OrderListBean> goodList) {

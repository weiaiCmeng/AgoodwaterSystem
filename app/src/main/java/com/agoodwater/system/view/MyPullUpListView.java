...
/**
 * Created by shiqiang on 2016/9/22.
 */
public class MyPullUpListView extends ListView implements OnScrollListener {
    ...
    public void initBottomView() {
        ...
        if (footerView == null) {
            ...
            tvMany = (TextView) footerView.findViewById(R.id.tv_many);
        }
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        ...
        }else if( scrollState == OnScrollListener.SCROLL_STATE_FLING && firstVisibleItem != 0){
    ...
    public void onScroll(AbsListView view, int firstVisibleItem,
        ...
        if (footerView != null) {
            ...
            if (visibleItemCount == totalItemCount) {
                ...
                tvMany.setVisibility(View.GONE);//隐藏底部布局
            } else {
                // addFooterView(footerView);
                tvMany.setVisibility(View.VISIBLE);//显示底部布局
            }
        }
